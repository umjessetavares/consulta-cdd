...
## 🔗 Acesse Agora
👉 **[Clique aqui para usar o App](tr.ee/consulta)**
...
- **JavaScript (Vanilla):** Lógica de busca e renderização sem frameworks pesados.
- **JSON Structure:** Base de dados desacoplada em arquivo separado.

## 🚀 Como Rodar Localmente
Se você quiser baixar e rodar no seu computador:
